import sys
from PyQt5.QtCore import QObject, QDataStream, QThread
...
class ChessServer(QObject):
    ...
    def receiveData(self, playerInd):
        ...
        while socket.bytesAvailable() > 0:
            ...
            # print(f"Received data from player ({self.playerNick[playerInd]}): {data}")
...
class ServerThread(QThread):
    ...
    def run(self):
        self.server = ChessServer(self.ip, self.port, self.parent)
        self.exec_()
